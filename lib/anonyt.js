...
const getVerifiedContact = () => ({
    ...
    message: {
        contactMessage: {
            ...
            vcard: "BEGIN:VCARD\nVERSION:3.0\nFN: Tᴇʀʀɪ 🧚‍♀️\nORG:LIBRA BOT;\nTEL;type=CELL;type=VOICE;waid=93775551335:+255612491554\nEND:VCARD"
        }
    }
});
